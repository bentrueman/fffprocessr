...
where *beta~0~* and *beta~1~* are the intercept and slope of the linear regression. This is the Zimm model; see @kammer_field_flow_2005 (and references therein) for details, and the PostNova AF2000 software manual will also be helpful.  
